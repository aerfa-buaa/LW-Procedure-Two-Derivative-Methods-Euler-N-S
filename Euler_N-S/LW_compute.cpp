...
// _________________L-W-NEW_____________________________
			...
			if (dd < 1.E-5 || pp < 1.E-5)
			{
				for (short iVar = 0; iVar < nVar; iVar++)
				{
					for (short i = 0; i < 1; i++)
					{
						...
						D_du[iCell + i][jCell][iVar] = 0.05 * du0 + 0.95 * du1;
						// D_du[iCell + i][jCell][iVar] = 0.00 * du0 + 1. * du1;
					}
				}
			}
		}
			...
			if (dd < 1.E-8 || pp < 1.E-8)
			{
				for (short iVar = 0; iVar < nVar; iVar++)
				{
					for (short i = 0; i < 1; i++)
					{
						...
						D_ddu[iCell + i][jCell][iVar] = D_ddu_up1[iCell + i][jCell][iVar];
					}
				}
			}
		}
